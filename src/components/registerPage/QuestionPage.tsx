  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4">
      <div className="w-full max-w-3xl p-6">
        ...
        <div className="w-full flex flex-col items-center"> {/* Centering container */}
          <form className="space-y-4 w-full max-w-md">
            <div className="flex items-center space-x-2 p-3 w-full border border-transparent rounded-md hover:border-purple-600 hover:ring-2 hover:ring-purple-600 transition duration-200">
              <input
                type="radio"
                id="radioOption1"
                name="radioGroup"
            ...
            <div className="w-full flex justify-center mt-4">
              <button
                className="w-full py-2 bg-purple-700 text-white font-semibold rounded-full hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600"
