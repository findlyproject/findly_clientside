...
import { DeleteAccountProps } from "@/types/Types";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <p className="text-gray-700 text-md font-semibold mb-4">
          Are you sure you want to delete the account linked to <br />{" "}
        ...
        {showPick && (
          <div className="  flex flex-col items-start">
            ...
            {reasons.map((item, index) => (
              <label
                key={index}
                className="flex items-center text-xs text-gray-700 mb-4 whitespace-nowrap"
              >
                <input
                  type="checkbox"
                  className="mr-2"
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button
            className={`px-4 py-2 text-white rounded-md ${
              selectedReasons.length > 0 && showPick
