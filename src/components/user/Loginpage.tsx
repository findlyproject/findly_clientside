...
function Loginpage() {
  ...
  const handleForgotPassword = async (values: FormValues) => {
    ...
    if (forgotPassword.rejected.match(result)) {
      toast.error("You Have no Account With This Email");
      return;
    }
  ...
  return (
    <div className="min-h-screen w-full py-4 sm:py-8 px-10 sm:px-4">
        ...
        <div className="flex items-center justify-center min-h-[85vh]">
          <div className="flex flex-col md:flex-row bg-white shadow-lg sm:shadow-2xl rounded-2xl sm:rounded-3xl overflow-hidden w-full">
            ...
            <div className="w-full md:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col justify-center">
              ...
              >
                {({ values }) => (
                  <Form className=" sm:mt-6 space-y-4">
                    <div>
                    ...
                    <button
                      className="w-full bg-primary active:bg-opacity-95 transition-all text-white text-sm sm:text-base font-semibold py-2 sm:py-3 rounded-full shadow-md hover:shadow-lg"
                      type="submit"
                    >
                      Sign In
                    </button>
