...
const CreatePost: React.FC<CreatePostProps> = ({ open }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    dispatch(addPostByUser({ description, mediaFiles: selectedFiles, routes }));
        ...
        <OutsideClickHandler onOutsideClick={() => setopen(false)}>
          <div className="max-w-lg mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              Share Your Thoughts: Create a Post to Engage and Inspire the
              Community
            </p>
