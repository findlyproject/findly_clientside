...
const Page1: React.FC = () => {
  return (
    <div><div className="mx-auto flex h-screen max-w-lg flex-col md:max-w-none md:flex-row md:pr-10">
    <div className="max-w-md rounded-3xl bg-gradient-to-t from-blue-700 via-blue-700 to-blue-600 px-4 py-10 text-white sm:px-10 md:m-6 md:mr-8">
      <p className="mb-20 font-bold tracking-wider">FINDLY</p>
      <p className="mb-4 text-3xl font-bold md:text-4xl md:leading-snug">
      Start Your Career <br />
        journey with us
      </p>
      <p className="mb-28 leading-relaxed text-gray-200">Join CORINE, the leading platform connecting job seekers with top employers. Register today and unlock exclusive job opportunities tailored to your skills and expertise.</p>
      {/* <div className="bg-primary rounded-2xl px-4 py-8">
        ...
        <div className="">
          <div className="flex items-center">
            <Image className="h-10 w-10 rounded-full object-cover" src="/images/y9s3xOJV6rnQPKIrdPYJy.png" alt="Simon Lewis" />
