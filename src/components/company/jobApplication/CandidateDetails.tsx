...
>>>>>>> 6d27253ffd7f2ceb7fb72e888ab8717decf1d9d7
      ...
      <div className=" mx-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-1 ">
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center md:min-h-[364px]">
              ...
              <p className="text-sm text-gray-500 text-center mb-4">
                ...
                <div className="mt-2 text-sm text-gray-600 border-t border-gray-100 pt-4">
                ...
                <div className="mb-6">
                  {activeTab === "CoverLetter" ? (
                    <>
                      ...
                      <textarea
                        className="w-full min-h-56 h-full border"
                        readOnly
                    ...
                    <button className="p-2 bg-primary text-white rounded-lg">Generate</button>
                        </div>
                        <textarea
                          className="w-full min-h-48 h-full border"
                      ...
                      <p className="text-red-600 flex items-center justify-center font-medium">
                        You already rejected the application.
                      </p>
                    ) : user?.status === "Accepted" ? (
                      <div>
                        <h3 className="text-lg flex items-center font-medium">
                          You already approved the application.Here is the job offer
                        </h3>
                        <textarea
