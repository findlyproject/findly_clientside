...
export default function ViewProfile() {
  const profiles = [
    {
      name: 'Anushree Jain',
      title: 'Co-founder, SocialTAG',
      followers: '150,808 followers',
    ...
    {
      name: 'Nidhi Sharma',
      title: 'Tech Mentor | Top Voice',
      followers: '57,747 followers',
      image: 'https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg='
    },
    {
      name: 'Rohit Kumar',
      title: 'Data Scientist',
      followers: '72,108 followers',
      image: 'https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg='
    },
    {
      name: 'Vikram Patel',
      title: 'Product Manager | Innovator',
      followers: '50,500 followers',
      image: 'https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg='
    },
    {
      name: 'Sonal Agarwal',
      title: 'AI Expert',
      followers: '33,900 followers',
      image: 'https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg='
    },
    {
      name: 'Priya Desai',
      title: 'Marketing Guru',
      followers: '42,212 followers',
      image: 'https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.jpg?s=612x612&w=0&k=20&c=9zbG2-9fl741fbTWw5fNgcEEe4ll-JegrGlQQ6m54rg='
    },
  ];
...
<div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden mt-5">
    ...
    <img className="w-full h-full" src={currentUser?.banner} alt="" />
...
<span>{currentUser?.role === "premium" && <Image src={verification} width={30}height={20} alt="Verified" />}</span>
  ...
  unoptimized 
/>
          <p className="text-center ms-5">{institute.name}</p>
        </div>
      ))}
    </div>
  </div>
...
<div className="p-6 border-t">
      ...
      <div className="flex space-x-1 overflow-x-auto p-2 justify-center flex-wrap">
        {profiles.slice(0, visibleProfiles).map((profile, index) => (
          <div key={index} className="flex items-center space-x-3 p-3 border rounded-lg shadow-sm w-64 mb-4 sm:w-80 md:w-96">
            <img className="w-20 h-50" src={profile.image} alt={profile.name} />
            <div>
              <p className="font-semibold">{profile.name}</p>
              <p className="text-sm text-gray-600">{profile.title}</p>
              <p className="text-xs text-gray-500">{profile.followers}</p>
      ...
      {visibleProfiles < profiles.length && (
        <button onClick={handleShowMore} className="w-full text-blue-600 mt-3 text-sm">Show all Top Voices →</button>
      )}
    </div>
